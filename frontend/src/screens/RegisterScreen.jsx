...
const Signup = () => {
  ...
  const submitHandler = async e => {
    ...
    try {
      await register({ user, email, password }).unwrap();
      navigate("/login");
    } catch (error) {
  ...
  return (
    <div className=" flex flex-col h-[60%] w-[100%] items-center justify-center  rounded-xl bg-transparent bg-clip-border text-white shadow-none">
